...
The orchestration design uses a central Orchestrator Agent or orchestration service to manage the support workflow. The orchestrator is responsible for invoking specialized agents, maintaining context, applying confidence gates, and assembling outputs into a reviewable result.
...
## 7. Shared Memory and Context Strategy
...
## 10. Routing and Escalation Workflow
...
## 17. MVP Evaluation Architecture
...
* Python runtime.
* CrewAI or equivalent orchestration framework.
